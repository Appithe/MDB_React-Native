    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                ...
                <Text style={{fontSize:10, marginTop: 5, color: "#FFFFFF", textAlign:'center'}}></Text>
                <Button style={{marginTop:10}} icon="facebook" mode="contained" onPress={() => console.log('Pressed')}> Registrarse con facebook </Button>
